<h1 align="center">auto-vote-topgg</h1>

<p align="center"> auto-vote-topgg automates voting for bots on top.gg using google chrome! </p>
...
> I am **NOT** the original creator of this package. All the credit goes to @Shrinkvine but he deleted/privated it for some reason. This package is merely a fork of his repository before it was unavailable, so I'm reuploading it as I think this is such a useful package for automation purposes. I will keep maintaining this package if it ever gets any PRs or issues but if you're the original author of this repository and you want me to remove it for whatever reason, please contact me on discord at `nonce#0001`.
